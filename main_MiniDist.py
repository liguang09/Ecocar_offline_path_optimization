...
n_opt_mindist= optimize.src.mini_distance.mini_distance(track= track_smooth_cl, normvectors= normvec_interp)
...
coe_x_opt, coe_y_opt, _, normvec = prep_track.src.spline_coeffs.spline_coeffs(track=opt_path_mindist_cl)
...
kappa_opt= prep_track.src.calc_head_curv_num.calc_head_curv_num(path= opt_path_mindist_cl[:, :2],
...
# Export result
#=======================================================================================================================
optimize.src.save_mini_dist.save_results(trajectory_opt=opt_path_mindist_cl,
